...
export default function Footer() {
  return (
    <footer className="bg-brand-navy text-white py-12 border-t-4 border-brand-teal">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-white">Platform</h4>
            <ul className="space-y-2 text-sm text-gray-300">
              <li>
                <Link href="/browse" className="hover:text-brand-gold transition-colors">
                  Browse Mentors
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/become-mentor" className="hover:text-brand-gold transition-colors">
                  Become a Mentor
                </Link>
              </li>
            </ul>
